  ...
  return (
    <section id="about" className="bg-gray-900 drop-shadow-lg">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-36 md:pl-28 flex flex-col md:items-start md:text-left mb-16 mt-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            ...
            <a
              href="https://www.linkedin.com/in/francescomagagna"
